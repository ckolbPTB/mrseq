...
import numpy as np
import pytest
from mrseq.sequences.epi2d_fid import epi2d_fid_kernel
from mrseq.sequences.epi2d_fid import main as create_seq
...
def test_mrd_trajectory(
    ...
    mrd_file = tmp_path / 'test_epi2d_fid_traj.h5'
