...
def test_add_se_rx_gain_calib_system_defaults_if_none(system_defaults):
    """Test if system defaults are used if no system limits are provided."""
    _, block_duration1 = add_se_receiver_gain_calibration(system=system_defaults)
    _, block_duration2 = add_se_receiver_gain_calibration(system=None)
